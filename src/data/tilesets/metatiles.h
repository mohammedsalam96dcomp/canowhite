...
const u16 gMetatiles_Primary2[] = INCBIN_U16("data/tilesets/primary/primary_2/metatiles.bin");
const u16 gMetatileAttributes_Primary2[] = INCBIN_U16("data/tilesets/primary/primary_2/metatile_attributes.bin");
