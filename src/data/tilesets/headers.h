...
const struct Tileset gTileset_Primary2 =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Primary2,
    .palettes = gTilesetPalettes_Primary2,
    .metatiles = gMetatiles_Primary2,
    .metatileAttributes = gMetatileAttributes_Primary2,
    .callback = NULL,
};
